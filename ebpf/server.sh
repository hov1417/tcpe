...
sudo rm -f /sys/fs/bpf/tc/globals/tcpe_conn_map \
           /sys/fs/bpf/tc/globals/tcpe_new_path_map \
           ...
           /sys/fs/bpf/tcpe_new_path_map \
           /sys/fs/bpf/tcpe_path_map

clang -O2 -g -Wall -target bpf -c writer.c -o server.o -DTRACE_PORTS=8080 -DIS_SERVER -DDEBUG_CODE
...
clang -g -O2 -Wall -target bpf -c reader.c -o reader-server.o -DTRACE_PORTS=8080 -DIS_SERVER -DDEBUG_CODE
