...
clang -O2 -g -Wall -target bpf -c writer.c -o server.o -DTRACE_PORTS=8080,8081 -DIS_SERVER -DDEBUG_CODE
...
clang -g -O2 -Wall -target bpf -c reader.c -o reader-server.o -DTRACE_PORTS=8080,8081 -DIS_SERVER -DDEBUG_CODE
