...
clang -O2 -g -Wall -target bpf -c writer.c -o client.o -DTRACE_PORTS=8080,8081 -DDEBUG_CODE
...
clang -g -O2 -Wall -target bpf -c reader.c -o reader-client.o -DTRACE_PORTS=8080,8081 -DDEBUG_CODE
